...
void writeU8(std::string &str, uint8_t value)
{
	str.push_back(value);
}
void writeU16(std::string &str, uint16_t value)
{
	Utils::writeU8(str, (value & 0xff00) >> 8);
	Utils::writeU8(str, (value & 0x00ff));
}
void writeU32(std::string &str, uint32_t value)
{
	Utils::writeU16(str, (value & 0xffff0000) >> 16);
	Utils::writeU16(str, (value & 0x0000ffff));
}
void writeU64(std::string &str, uint64_t value)
{
